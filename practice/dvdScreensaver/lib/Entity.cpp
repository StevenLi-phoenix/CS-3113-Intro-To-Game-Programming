...
Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath, 
    ...
    mColliderDimensions {scale}, mTint {WHITE}, mTexture {LoadTexture(textureFilepath)}, 
...
{
    update(deltaTime, nullptr, nullptr, nullptr, 0);
}

void Entity::update(float deltaTime, Entity *player)
{
    update(deltaTime, player, nullptr, nullptr, 0);
}

void Entity::update(float deltaTime, Entity *player, Map *map)
{
    update(deltaTime, player, map, nullptr, 0);
}
