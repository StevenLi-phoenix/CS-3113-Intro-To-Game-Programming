...
void render()
{
    ...
    gShader.setVector2("isoOrigin", ORIGIN);
    gShader.setFloat("isoScale", 1.0f);
    gShader.setInt("useIsometric", gUseIsometric ? 1 : 0);
