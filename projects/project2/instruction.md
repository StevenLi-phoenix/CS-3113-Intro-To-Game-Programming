...
- You do not need to use the Entity class in this assignment, but you may if you'd like.
...
- If the player presses the `t`-key, one of the paddles should switch from player-controlled to a simple up-and-down motion.
- Ensure the user can't use their keys to move the paddle when in 1-player mode.

### Requirement 3: Have an option to choose number of balls (30%)

- Allow the player to press number keys from `1`–`3` and generate that number of balls on the screen (do not generate more than 3 balls).
- The player should be able to change the number of balls any time during the game.
