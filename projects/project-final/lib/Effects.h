...
private:
    ...
    EffectsConstants::EffectType mCurrentEffect;
    Vector2 mViewOffset;
    Vector2 mOrigin;
...
public:
    ...
    void start(EffectsConstants::EffectType effectType);
    ...
    EffectsConstants::EffectType getCurrentEffect() const { return mCurrentEffect; }
    ...
    void setCurrentEffect(EffectsConstants::EffectType effect)   { mCurrentEffect = effect;        }
